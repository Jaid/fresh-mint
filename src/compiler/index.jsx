...
export default setup => {
    ...
    const enabledInstalls = Object.entries(setup.installPackages).filter(([id, enabled]) => enabled)
    for (const [id, enabled] of enabledInstalls) {
        script.addCode(new AptInstallTemplate(id).compile(setup))
    }

    script.header = enabledInstalls.length
