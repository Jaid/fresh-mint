/*
 * This code is based on shell-escape-tag
 * https://github.com/chocolateboy/shell-escape-tag
 * Unfortunately shell-escape-tag imports source-map-support what breaks Browser usage
 */
...
function _shellEscape(params, options = {}) {
    ...
    let flattened = lodash.flattenDeep(escaped)
...
export default function shell(strings, ...params) {
    ...
    for (let [string, param] of lodash.zip(strings, params)) {
